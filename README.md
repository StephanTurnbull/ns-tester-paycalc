...
- **E Grade Electrical Allowance (A440)** — applied to all physically worked hours except project shifts
- **Project shift allowances** — Site Allowance and JumpUp-Infra (in place of A440) applied to Project EX shifts
